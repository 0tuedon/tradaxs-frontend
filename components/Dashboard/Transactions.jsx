...
const Transactions = () => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-10 font-medium text-white gap-x-2 gap-y-3 md:gap-5 place-items-start justify-content-start max-w-3xl">
      <div className="flex items-center justify-between px-5 py-3 sm:p-3 space-x-3 rounded-md w-full max-w-full bg-landingBlue">
        <span>
      ...
      <div className="flex items-center justify-between px-5 py-3 sm:p-3 space-x-3 rounded-md bg-landingBlue w-full max-w-full">
        <span>
      ...
      <Link href="/dashboard/transactions" passHref>
        <a className="flex items-center justify-between px-5 py-3 sm:p-3 space-x-3 rounded-md bg-landingBlue w-full max-w-full">
          <span>
