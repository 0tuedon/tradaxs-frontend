...
const BuyModal = () => {
  return (
    <div className="bg-landingBlue w-full gap-5 max-w-4xl px-4 rounded-md absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col lg:flex-row justify-between items-start">
      <div className="max-w-md py-5 lg:border-r-2 lg:pr-5 h-full lg:border-white">
        ...
        <div>
          <h2 className="text-sm font-semibold mb-1">Terms and conditions</h2>
          <p className="text-sm">
            Fast payment; fast release. I&apos;m active, don&apos;t include
            “bitcoin” or anything related to cryptocurrency in your payment
            description. Because of our Banks 👏🏽👏🏽 fast trade
          </p>
        </div>
      </div>
      <form className="flex-auto py-5 text-sm w-full">
        ...
        <span className="text-xs text-accent font-semibold flex gap-3">
          <button className="bg-white rounded-md py-2 px-4 lg:px-10 opacity-50 transition-all duration-200 hover:opacity-100">
            Cancel
          </button>
          <button className="bg-white rounded-md py-2 px-4 lg:px-10">
            Buy USDT
          </button>
        </span>
      </form>
