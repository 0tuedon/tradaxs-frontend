...
const HeaderNav = () => {
  ...
  return (
    <span className="relative">
      <button
        className="flex items-center justify-between gap-2 text-sm transition-transform duration-200 hover:scale-110"
      ...
      <ul
        className={`absolute right-0 w-48 p-3 z-10 space-y-2 text-sm font-medium transition-transform duration-200 ${
